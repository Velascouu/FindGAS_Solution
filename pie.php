        ...
        <div class="modal-dialog">
            <div class="modal-content" style="padding: 50px;">
                ...
                <form name="inicioSesion" action="javascript:checkInicio()">
                    ...
                    <input type="text" class="form-control" id="user" aria-describedby="emailHelp" placeholder="Usuario">
                    ...
                    <button type="submit" class="btn btn-primary" style="float: right;" onclick="obtenerUser()">Iniciar sesión</button>
                </form>
            </div>
        </div>
    </div>
