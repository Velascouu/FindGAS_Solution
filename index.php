        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4" id="welcomeArea">
                    <div>
                        <img src="./assets/img/FindGAS_icono_modified.png" class="card-img-top" alt="..." style="max-height: 250px; max-width: 250px; margin: 15% 15%;">
                    ...
                    <div class="card" style="width: 100%; height: auto; background-color: rgb(239, 255, 240); border-radius: 10px; margin-top: 20px; margin-bottom: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <li class="list-group-item" style="width: 100%; height: auto; background-color: rgb(239, 255, 240);">
                                    ...
                                    <select class="form-select" id="selectCombusti" name="selectCombusti" aria-label="Default select example" onchange="buscarEESSporMun(document.getElementById('selectMunicipio').value)">
                                ...
                                <li class="list-group-item" style="width: 100%; height: auto; background-color: rgb(239, 255, 240);">
                                    ...
                                    <select class="form-select" id="selectCCAA" name="selectCCAA" aria-label="Default select example" onchange="buscarProvincias(document.getElementById('selectCCAA').value); buscarEESSxCCAAyPrecio(document.getElementById('selectCCAA').value, document.getElementById('selectCombusti').value);">
                                        <option selected disabled>Selecciona una CCAA</option>
                                    </select>
                                </li>
                                <li class="list-group-item" style="width: 100%; height: auto; background-color: rgb(239, 255, 240);">
                                    <h6 class="card-subtitle mb-2 text-muted">Provincia:</h6>
                                    <select class="form-select" id="selectProvincia" name="selectProvincia" aria-label="Default select example" onchange="buscarMunicipios(document.getElementById('selectProvincia').value); buscarEESSxProvinciayPrecio(document.getElementById('selectCCAA').value, document.getElementById('selectCombusti').value);">
                                        <option selected disabled>Selecciona una PROVINCIA</option>
                                    </select>
                                </li>
                                <li class="list-group-item" style="width: 100%; height: auto; background-color: rgb(239, 255, 240);">
                                    <h6 class="card-subtitle mb-2 text-muted">Municipio:</h6>
                                    <select class="form-select" id="selectMunicipio" name="selectMunicipio" aria-label="Default select example" onchange="buscarEESSxMunicipioyPrecio(document.getElementById('selectMunicipio').value, document.getElementById('selectCombusti').value);">
                                        <option selected disabled>Selecciona un MUNICIPIO</option>
                                    </select>
                                </li>
                              </ul>
                              <h5 style="color: darkgray;">Precio medio:</h5>
                              <div id="inputPrecioMedio" style="width: 500px; text-align: center; padding: 20px; background-color: white; border-radius: 5px;"></div>
